...
Generated at: `2026-08-04T17:33:18+00:00`
...
| RK3576 CPU ONNX Runtime | pending | RK3576 ARM CPU | FP32 or INT8 CPU EP | single image and camera loop | - | - | - | pending |
...
- **RK3576 CPU ONNX Runtime**: Useful as a board-local CPU fallback; package/runtime not benchmarked yet.
